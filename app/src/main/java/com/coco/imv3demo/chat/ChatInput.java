...
public class ChatInput extends RelativeLayout implements TextWatcher,View.OnClickListener {
    ...
    private void updateVoiceView(){
        if (isHoldVoiceBtn){
            ...
            voicePanel.setBackground(getResources().getDrawable(R.mipmap.zeffect_recordbutton__recordview_bottom));
            chatView.startSendVoice();
        }else{
            voicePanel.setText(getResources().getString(R.string.chat_press_talk));
            voicePanel.setBackground(getResources().getDrawable(R.mipmap.zeffect_recordbutton_record_litter_top));
